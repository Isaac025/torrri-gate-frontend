  ...
  return (
    <div className="flex justify-between items-center p-4 bg-white rounded-md shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="p-2 rounded-md bg-black text-white w-8 h-8 flex items-center justify-center cursor-pointer">
          {page}
        </button>
        <span className="text-[#595959] text-sm">of</span>
        <button className="p-2 rounded-md bg-[#f6f6f6] text-[#0c0c0c] w-8 h-8 flex items-center justify-center cursor-pointer">
          {totalPages}
        </button>
      </div>
    </div>
